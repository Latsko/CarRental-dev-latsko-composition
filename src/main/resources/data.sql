...
VALUES ('Toyota', 'Corolla', 'Sedan', 2023, 'Silver', 15000, 0, 25000.00, 1),
       ('Honda', 'Civic', 'Hatchback', 2022, 'Blue', 20000, 1, 22000.00, 2),
       ('Ford', 'Mustang', 'Coupe', 2023, 'Red', 12000, 2, 35000.00, 3),
       ('Chevrolet', 'Malibu', 'Sedan', 2022, 'Black', 18000, 0, 28000.00, 1),
       ('Nissan', 'Altima', 'Sedan', 2023, 'White', 16000, 1, 26000.00, 2),
       ('Audi', 'A4', 'Sedan', 2023, 'Gray', 14000, 2, 32000.00, 3),
       ('BMW', '3 Series', 'Sedan', 2022, 'Silver', 19000, 0, 38000.00, 1),
       ('Mercedes-Benz', 'C-Class', 'Sedan', 2023, 'Black', 17000, 1, 40000.00, 2),
       ('Volkswagen', 'Passat', 'Sedan', 2022, 'Blue', 15000, 2, 27000.00, 3),
       ('Hyundai', 'Elantra', 'Sedan', 2023, 'Red', 13000, 0, 24000.00, 1),
       ('Tesla', 'Model S', 'Sedan', 2023, 'White', 10000, 1, 60000.00, 2),
       ('Kia', 'Seltos', 'SUV', 2022, 'Gray', 17000, 2, 23000.00, 3),
       ('Subaru', 'Outback', 'Wagon', 2023, 'Green', 12000, 0, 27000.00, 1),
       ('Mazda', 'CX-5', 'SUV', 2022, 'Red', 14000, 1, 26000.00, 2),
       ('Jeep', 'Wrangler', 'SUV', 2023, 'Black', 9000, 2, 35000.00, 3),
       ('Lexus', 'RX', 'SUV', 2022, 'Silver', 16000, 0, 40000.00, 1),
       ('Infiniti', 'Q50', 'Sedan', 2023, 'Blue', 11000, 1, 32000.00, 2),
       ('Volvo', 'XC60', 'SUV', 2022, 'White', 13000, 2, 38000.00, 3),
       ('Porsche', '911', 'Coupe', 2023, 'Red', 8000, 0, 120000.00, 1),
       ('Ferrari', '488 GTB', 'Coupe', 2022, 'Yellow', 5000, 1, 250000.00, 2);
